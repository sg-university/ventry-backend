...
from app.outer.interfaces.deliveries.contracts.requests.management.permission_management.create_body import \
    CreateBody
from app.outer.interfaces.deliveries.contracts.requests.management.permission_management.patch_body import \
    PatchBody
...
async def create_one(entity: CreateBody) -> Content[Permission]:
...
async def patch_one_by_id(id: UUID, entity: PatchBody) -> Content[Permission]:
