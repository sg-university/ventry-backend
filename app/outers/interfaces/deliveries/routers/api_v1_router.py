...
from app.outers.interfaces.deliveries.controllers import location_controller, item_file_map_controller, \
    ...
    item_controller, forecast_controller, authentication_controller, company_controller, company_account_map_controller, \
    company_location_map_controller
...
api_v1_router.include_router(company_account_map_controller.router)
api_v1_router.include_router(company_location_map_controller.router)
