...
from app.outers.interfaces.deliveries.controllers import permission_controller, item_file_map_controller, \
    ...
    account_permission_map_controller, item_controller, forecast_controller, authentication_controller
