...
from app.inners.models.value_objects.contracts.requests.managements.items.create_body import CreateBody
...
async def teardown(request: pytest.FixtureRequest):
    ...
    if request.node.name == "test__create_one__should_create_one_item__success":
        item_mock_data.pop()
